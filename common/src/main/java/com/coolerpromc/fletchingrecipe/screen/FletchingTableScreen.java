...
public class FletchingTableScreen extends AbstractContainerScreen<FletchingTableMenu> {
    public static final Identifier TEXTURE = Constants.id("textures/gui/fletching_table.png");
    ...
    protected void containerTick() {
        ...
        if (this.menu.isExplosiveEnabled()) {
            this.explosionSlotBackground.tick(List.of(Constants.id("empty_slot_gunpowder"), Constants.id("empty_slot_tnt")));
        }
    }
