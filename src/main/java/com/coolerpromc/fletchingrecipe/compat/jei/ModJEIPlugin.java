...
public class ModJEIPlugin implements IModPlugin {
    ...
    public void registerItemSubtypes(ISubtypeRegistration registration) {
        registration.registerFromDataComponentTypes(Items.ARROW, FletchingRecipe.EXPLOSIVE);
        registration.registerFromDataComponentTypes(Items.SPECTRAL_ARROW, FletchingRecipe.EXPLOSIVE);
        registration.registerFromDataComponentTypes(Items.TIPPED_ARROW, FletchingRecipe.EXPLOSIVE);
    }
}